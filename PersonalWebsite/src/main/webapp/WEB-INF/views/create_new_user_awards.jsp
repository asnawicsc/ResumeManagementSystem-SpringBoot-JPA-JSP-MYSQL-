...
<title>Register New User Awards</title>
<link
	...
	<section>
		...
		<div class="card">
			<div class="card-body">
				...
				<form action="/addNewAwards" method="post">
					<div class='loginForm'>
						<h1>New User Awards</h1>
						<br>
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="awards_desc"
								name="awards_desc"> <label for="awards_desc">Awards
								Description</label>
						</div>
